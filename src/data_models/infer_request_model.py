...
def get_inference_request_body_model(schema: BinaryClassificationSchema) -> BaseModel:
    ...
    class InferenceRequestBody(BaseModel):
        ...
        - Nullable features are allowed to have null values. Non-nullable features must have non-null values.
        - For categorical features, the given value must be one of the allowed values as defined in the schema file.
