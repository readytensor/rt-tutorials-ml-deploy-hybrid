...
ML_MOUNT = os.path.join(ROOT_DIR, "ml_mount")

# Path to inputs
INPUT_DIR = os.path.join(ML_MOUNT, "inputs")
...
MODEL_PATH = os.path.join(ML_MOUNT, "model")
...
# Path to outputs
OUTPUT_DIR = os.path.join(ML_MOUNT, "outputs")
